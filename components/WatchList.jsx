   ...
   return (
    <div className='w-full min-h-[400px] bg-black mt-[80px] relative' >
       <div className='w-full h-full absolute top-0 left-0'>
        ...
        {/* <h1 className='text-[25px] text-pink-700 font-semibold
          text-center pt-5 relative z-10 capitalize'>Your personal collection of favorite movies is here!</h1> */}
        <h1 className="text-2xl pt-5 font-extrabold text-center 
         bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 
         bg-clip-text text-transparent drop-shadow-lg animate-fade-in">
        <span className='text-white'>🎬</span>  Your Personal Collection Of Favorite Movies Is Here!
       </h1>
        ...
        <div className='w-full min-h-[300px] relative z-10 py-[50px] 
                    ...
                    return (
                        ...
                        className=' w-full h-[250px] xs:h-[200px] border-[1px] transition-all duration-300 ease-linear
                         border-violet-400 rounded-2xl relative overflow-hidden '>
                             ...
                             {/* <a href={`/pages/movies/${item.id}`}></a> */}
                             <a href={`/pages/movies/${item.id}`}
                               className={`w-full h-full bg-gradient-to-b from-black/70 to-purple-900/80 
                                ...
                                ${showHoverId === item.id ? 'translate-y-0' : 'translate-y-full'}
                            `}
                        >
