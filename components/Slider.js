          ...
          return (
            ...
            >
              <div className="w-full h-full overflow-hidden relative">
                ...
                <div className=" absolute bottom-[20%] left-[20px] md:left-[50px] xl:left-[100px] z-30 w-[90%] sm:w-[70%] lg:w-[500px] min-h-[100px] flex justify-start items-start gap-2 md:gap-5 flex-col text-[13px] sm:text-[16px]">
