...
export default function MovieBox({movieData}) {
  ...
  return (
     <div className="bg-black w-full min-h-[400px] pt-[50px]">
                ...
                return (
                 ...
                 <div  className="w-full h-full bg-black/50 absolute top-0 left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                   ...
                   <div className="flex justify-between items-center
                    absolute bottom-0 left-0 bg-black py-[10px] px-[5px]">
                    <h1 className="text-violet-400 text-[16px] 
                    font-semibold truncate w-[180px]">
                      {item.title}
                    </h1>
    
                    <div className="text-gray-100 bg-violet-400 
