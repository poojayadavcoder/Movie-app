...
export default function Popup() {
  ...
  return (
    <>
   {!showPlayer &&   <div
        className={`w-[90%] sm:w-[600px] h-[450px] pb-4 border-[1px] border-white 
      ...
      >
        ...
        <div className="relative w-full min-h-[300px] pb-3 overflow-hidden">
          ...
          />
          {/* <div
              className="hidden sm:flex  pointer-events-none absolute inset-0 z-10 
        shadow-[inset_150px_-100px_200px_rgba(0,0,0,2)]
        "
            /> */}
        </div>
        <h1 className="text-[26px] font-bold text-white pl-2 drop-shadow-[0_0_12px_rgba(167,139,250,0.9)]">
          {popItem.title}
        </h1>
        ...
        <button
          onClick={() => handleWatchNow(popItem.trailer)}
